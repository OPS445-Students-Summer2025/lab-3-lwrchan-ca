...
#The purpose of this script is to have a number of functions that 
# return a selected number of items from a given list. 
# Each function will return either a single item from the list 
# OR will create a new list and return the entire new list.
